...
if command -v stockfish >/dev/null 2>&1; then
    ...
    echo -e "  Since you are on Arch Linux, you can install it easily with:"
    echo -e "  \e[1;36m  sudo pacman -S stockfish\e[0m"
    echo
    read -p "  Press Enter to continue (we will look in default path /usr/bin/stockfish)..."
